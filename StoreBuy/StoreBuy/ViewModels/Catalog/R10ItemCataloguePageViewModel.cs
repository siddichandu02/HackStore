...
namespace StoreBuy.ViewModels.Catalog
{
    ...
    [DataContract]
    public class R10ItemCataloguePageViewModel : BaseViewModel
    {
        #region Fields  
        ...
        public R10ItemCataloguePageViewModel(INavigation _navigation)
        {
        ...
        public async void GetItems()
        {
            ...
            var ItemCatalogue = await DataItems.GetR10ServiceItems(ItemCategoryId);
