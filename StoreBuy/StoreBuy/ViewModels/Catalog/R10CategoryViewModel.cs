...
namespace StoreBuy.ViewModels.Catalog
{
    ...
    [DataContract]
    public class R10CategoryViewModel : BaseViewModel
    {
        #region Fields
        ...
        public R10CategoryViewModel(INavigation navigation)
        {
        ...
        public async void GetCategories()
        {
            ...
            var CategoryList = await DataCategory.AllR10Categories();
        ...
        private async void CategorySelected(object obj)
        {
            ...
            await Navigation.PushAsync(new R10ItemTilePage());
        }
